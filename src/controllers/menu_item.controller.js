...
exports.addMenuItem = async (req, res) => {
    try {
        ...
        const {title, price, netPrice, taxId, categoryId,list} = req.body;
        ...
        const menuItemId = await addMenuItemDB(title, price, netPrice, taxId, categoryId, tenantId,list);
...
exports.updateMenuItem = async (req, res) => {
    try {
        ...
        await updateMenuItemDB(id, title, price, netPrice, taxId, categoryId, tenantId,list);
